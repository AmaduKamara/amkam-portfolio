...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      skills: [{
        title: "Web Design",
        content: "I do Web Design with different tools and technologies, from HTML and CSS, JavaScript, Bootstrap, TailwindCSS, Wordpress, Webflow and Wix.",
        icon: "fas fa-desktop"
      }, {
        title: "Frontend Development",
        content: "I do Frontend Development with different modern tools and technologies, from HTML and CSS, JavaScript, Bootstrap, TailwindCSS, Vue JS, React JS and Laravel - web application framework with expressive, elegant syntax.",
        icon: "fas fa-laptop"
      }, {
        title: "UI/UX Design",
        content: "I Design professional User Interfaces(UI) and User Experience(UX) with modern tools and technologies, from A4 paper with sketches and wireframing, Adobe XD, Figma for Mobile applications and Web applications.",
        icon: "fas fa-desktop"
      }, {
        title: "Web Instructor",
        content: "I faced lots of challenges when I started programming and things get easier as I go along. I realized I should help interested and dedicated students like I was in teaching them Web Development from scratch, to UI/UX and real development with modern technologies.",
...
// module
exports.push([module.i, ".heroSection[data-v-b3c5cf30] {\n  height: 600px;\n}\n", ""]);
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "bg-gray-300" }, [
      _c("footer", { staticClass: "text-center py-4" }, [
        _c("small", { staticClass: "text-gray-600" }, [
          _vm._v("© Amkam 2020. Alright reserved.")
        ])
      ])
    ])
  }
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "bg-gray-100 shadow-md sm:flex sm:justify-between sm:px-4 sm:py-3 border-t-4 border-teal-600"
    },
    [
      _c(
        "div",
        {
          staticClass:
            "container sm:flex items-center sm:justify-between mx-auto md:px-4"
        },
        [
          _c(
            "nav",
            {
              staticClass:
                "flex items-center justify-between px-4 py-2 sm:p-0 sm:border-none"
            },
            [
              _vm._m(0),
              _vm._v(" "),
              _c("div", { staticClass: "sm:hidden" }, [
                _c(
                  ...
                  {
                    staticClass:
                      "text-teal-500 focus:text-teal-600 focus:outline-none hover:text-teal-600 block transition delay-150 duration-200 ease-in-out",
                    attrs: { type: "button" },
                    on: {
          ...
          _c(
            "div",
            {
              staticClass: "px-2 pt-2 pb-4 sm:flex sm:p-0 sm:pt-1",
            ...
            [
              _c(
                ...
                {
                  staticClass:
                    "block sm:inline-block font-semibold hover:bg-teal-600 hover:text-gray-200 rounded px-2 py-1 text-gray-900",
                  attrs: { to: "/", exact: "" }
                },
                [_vm._v("Home")]
              ),
              ...
              _c(
                ...
                {
                  staticClass:
                    "block sm:inline-block font-semibold hover:bg-teal-600 hover:text-gray-200 rounded px-2 py-1 mt-1 sm:mt-0 sm:ml-3 text-gray-900",
...
var staticRenderFns = [
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", [
      _c("h1", { staticClass: "text-gray-200 font-sans text-2xl" }, [
        _c("a", { staticClass: "text-gray-700", attrs: { href: "#" } }, [
          _c("span", { staticClass: "text-teal-400" }, [_vm._v("Am")]),
          _vm._v("kam\n                    ")
        ])
      ])
    ])
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._m(2),
      _vm._v(" "),
      _c("div", { staticClass: "py-12 px-6" }, [
        _vm._m(3),
        _vm._v(" "),
        _c(
          "div",
          { staticClass: "by-gray-100 my-5" },
          _vm._l(_vm.skills, function(skill) {
            return _c(
              ...
              [
                _c("div", { staticClass: "py-5 px-4 my-8 rounded" }, [
                  _c("div", { staticClass: "text-center mb-5" }, [
                    _c("i", {
                      staticClass: "text-6xl text-teal-500",
                      class: skill.icon
                    })
                  ]),
                  _vm._v(" "),
                  _c("div", [
                    _c(
                      ...
                      {
                        staticClass:
                          "text-2xl leading-tight uppercase text-center mb-2 text-teal-500"
                      },
                      [_vm._v(_vm._s(skill.title))]
                    ),
                    _vm._v(" "),
                    _c("p", { staticClass: "text-gray-600 text-center" }, [
                      _vm._v(_vm._s(skill.content))
                    ])
                  ])
                ])
              ]
      ...
      _vm._v(" "),
      _c("div", { staticClass: "bg-gray-200 py-12 px-4" }, [
        _vm._m(4),
        _vm._v(" "),
        _c(
          "div",
          { staticClass: "mt-8 px-4" },
          [
            _c(
              "h4",
              {
                staticClass:
                  "text-xl leading-tight mb-2 text-teal-500 uppercase"
              },
              [_vm._v("Web Design")]
            ),
            _vm._v(" "),
            _vm._l(_vm.webExperience, function(experience) {
              return _c(
                "div",
                { key: experience.title, staticClass: "relative" },
                [
                  _c(
                    "div",
                    ...
                    [
                      _c("div", [
                        _c(
                          ...
                          {
                            staticClass:
                              "text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-teal-700 bg-teal-300"
                          },
                      ...
                      _c("div", { staticClass: "text-right" }, [
                        _c(
                          ...
                          {
                            staticClass:
                              "text-xs font-semibold inline-block text-teal-600"
                          },
                          [_vm._v(_vm._s(experience.percent))]
                        )
                      ])
                    ]
                  ),
                  ...
                  _c(
                    ...
                    {
                      staticClass:
                        "overflow-hidden h-2 mb-4 text-xs flex rounded bg-teal-200"
                    },
                    [
                      _c("div", {
                        staticClass:
                          "shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-teal-600",
        ...
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _vm._l(_vm.frontExperience, function(experience) {
              return _c(
                "div",
                { key: experience.title, staticClass: "relative" },
                [
        ...
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _vm._l(_vm.designExperience, function(experience) {
              return _c(
                "div",
                { key: experience.title, staticClass: "relative" },
                [
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "relative heroSection h-screen" }, [
      _c("div", { staticClass: "image" }, [
        _c("img", {
          staticClass: "object-cover w-full pt-5 heroImg",
          attrs: { src: "images/Amadu Kamara.png", alt: "Amadu Kamara" }
        })
      ]),
      _vm._v(" "),
      _c(
        ...
        {
          staticClass:
            "absolute -mt-12 bg-gray-200 p-8 mx-4 rounded shadow-2xl text-white mb-8 border border-gray-300"
        },
        [
          _c("h4", { staticClass: "text-center text-teal-500 text-xl" }, [
            _vm._v("Hello!")
          ]),
          _vm._v(" "),
          _c(
            "h3",
            { staticClass: "text-center text-teal-500 text-2xl leading-tight" },
            [_vm._v("I Am Amadu Kamara, aka Amkam.")]
          ),
          _vm._v(" "),
          _c(
            "p",
            {
              staticClass:
                "text-sm mt-2 text-center text-gray-500 leading-normal"
            },
            [
              _vm._v(
                "I am Web Designer, Developer, UI/UX Designer and A Web Instructor with 4 years experience."
              )
            ]
          )
        ]
  ...
  function() {
    ...
    return _c("div", { staticClass: "my-6" }, [
      _c(
        "div",
        { staticClass: "card bg-white shadow-xl mx-4 rounded py-4 px-4" },
        [
          _c("h4", [
            _c("a", { attrs: { href: "#" } }, [
              _c("i", { staticClass: "fas fa-desktop text-teal-500" }),
              _vm._v(" Web Design\n        ")
            ])
          ])
        ]
      ...
      _c(
        "div",
        { staticClass: "card mt-4 bg-white shadow-xl mx-4 rounded py-4 px-4" },
        [
          _c("a", { attrs: { href: "#" } }, [
            _c("h4", [
              _c("i", { staticClass: "fas fa-laptop text-teal-500" }),
              _vm._v(" Frontend Development\n        ")
            ])
          ])
        ]
      ...
      _c(
        ...
        [
          _c("a", { attrs: { href: "#" } }, [
            _c("h4", [
              _c("i", { staticClass: "fas fa-window-maximize text-teal-500" }),
              _vm._v(" Web Instructor\n        ")
            ])
          ])
        ]
      )
  ...
  function() {
    ...
    return _c("div", { staticClass: "my-6" }, [
      _c("div", { staticClass: "hidden" }, [
        _c("img", {
          attrs: {
            src: "images/Photo In PC.png",
            alt: "Amkam Website in computer"
          }
        })
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "px-8 bg-gray-200 mt-10 py-12" }, [
        _c(
          "h4",
          {
            staticClass:
          ...
          [_vm._v("I love being part of a brand's growth")]
        ),
        _vm._v(" "),
        _c("p", { staticClass: "text-gray-600 text-center" }, [
          _vm._v(
            "My mission is to help businesses grow by making their presence online possible. My joy is to see all businesses move their operations online and be counted a part of that mission."
          )
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "text-center mt-6" }, [
          _c(
            ...
            {
              staticClass:
                "bg-teal-500 py-2 px-6 rounded-full text-white mr-3 hover:bg-white hover:text-gray-600 hover:border-teal-500 transition delay-150 duration-200 ease-in-out",
              attrs: { href: "#" }
            },
            [_vm._v("Hire Me")]
          ),
          ...
          _c(
            ...
            {
              staticClass:
                "bg-transparent border border-teal-500 py-2 px-4 rounded-full hover:bg-teal-500 hover:text-gray-200 transition delay-200 duration-150 ease-in-out",
              attrs: { href: "#" }
            },
            [_vm._v("Download CV")]
          )
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "text-center px-4" }, [
      _c(
        "h3",
        {
          staticClass:
        ...
        [_vm._v("About My Skills")]
      ),
      _vm._v(" "),
      _c("p", { staticClass: "text-gray-600 text-center" }, [
        _vm._v(
          "I have skills in four main areas so far from my experience as a programmer. My experty lies in the following: Web Design , Frontend Development, UI/UX Design and I also teach Web Development at my residence."
        )
      ])
    ])
  },
  function() {
    ...
    return _c("div", { staticClass: "text-center px-4" }, [
      ...
      _c("p", { staticClass: "text-gray-600 text-center" }, [
        _vm._v(
          "I started learning programming at Limkokwing University of Creative Technology at my 3rd day on campus with C++ Programming Language. Below are the experience I've got since I started writing code in 2016."
        )
      ])
    ])
  },
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "bg-gray-100 py-12 px-4" }, [
      _c("div", { staticClass: "text-center px-4" }, [
        _c(
          ...
          [_vm._v("How I Do My Work")]
        ),
        _vm._v(" "),
        _c("p", { staticClass: "text-gray-600 text-center" }, [
          _vm._v(
            "As a software developer or engineer, I strongly follow the principles of software development which deals with Software Development Life Cycle(SDLC)."
          )
        ])
      ])
    ])
...
/* harmony import */ var _pages_Skills_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./pages/Skills.vue */ "./resources/js/pages/Skills.vue");
...
var routes = [{
  ...
  path: '/skills',
  name: 'Skills',
  component: _pages_Skills_vue__WEBPACK_IMPORTED_MODULE_4__["default"]
}, {
  path: '/portfolio',
  name: 'Portfolio',
...
__webpack_require__(/*! C:\Users\Fix Solution\Documents\Laravel\LaravelVue\amkam\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\Fix Solution\Documents\Laravel\LaravelVue\amkam\resources\css\main.css */"./resources/css/main.css");
